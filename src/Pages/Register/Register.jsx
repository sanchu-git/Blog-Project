  ...
  return (
    <>
      <div style={{ height: 'auto', overflowX: 'hidden', background: 'url(https://images.unsplash.com/photo-1548092372-0d1bd40894a3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className='w-auto'>
        <div style={{ height: '100vh', width: '100%' }} className=' d-flex  justify-content-center '>
          <div style={{ width: '950px', height: '675px', boxShadow: 'rgba(280, 130, 265, 1) 0px 5px 15px' }} className='row d-flex bg-black mt-5 ms-5 rounded'>
            <div style={{ height: '513px',marginTop:150 }} className="col-lg-5">
              <div style={{ background: 'url(https://i.pinimg.com/736x/97/69/09/976909d77fdf5ed59a9622dfefd8d8f0.jpg)', height: '513px', backgroundRepeat: 'none', backgroundSize: 'cover' }} className=' mt-0  rounded'>
                <div className='me-5' >
                </div>
              </div>
            </div>
